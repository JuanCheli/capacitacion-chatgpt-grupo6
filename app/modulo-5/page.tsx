...
export default function Module5Page() {
  ...
  const questions = [
    ...
    },
    {
      id: 2,
      question:
        "¿Por qué ChatGPT no es un reemplazo de profesionales como médicos o abogados?",
      options: [
    ...
    },
    {
      id: 3,
      question:
        "¿Qué debes hacer si ChatGPT te da información importante sobre salud o finanzas?",
      options: [
    ...
    },
    {
      id: 5,
      question:
        "¿Qué debes hacer al terminar de usar ChatGPT en una computadora compartida?",
      options: [
      ...
      <Card>
        ...
        <CardContent>
          <div className="aspect-video bg-muted rounded-lg overflow-hidden">
            <iframe
              className="w-full h-full"
              src="https://docs.google.com/presentation/d/1gpslHEPDLAuScq2388zZK8CZcsgCOBmw0q0jcukPJlE/embed?start=false&loop=false&delayms=3000"
      ...
      <div className="space-y-6">
        <Alert className="border-destructive">
          ...
          <AlertDescription className="text-base leading-relaxed">
            <strong>Importante:</strong> Tu seguridad es lo primero. Lee este
            módulo con atención para proteger tu información personal.
          </AlertDescription>
        </Alert>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Nunca escribas tus contraseñas de correo, banco, redes
                      sociales, etc.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Evita compartir tu DNI, pasaporte o número de seguro
                      social completo.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Puedes mencionar tu ciudad o barrio, pero no tu dirección
                      completa.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Puedes hacer preguntas generales, pero no compartas
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">
            Reconocer límites y posibles errores de la IA
          </h2>
          <Card>
            <CardContent className="pt-6 space-y-4">
              <Alert>
                ...
                <AlertDescription className="text-base leading-relaxed">
                  ChatGPT es muy útil, pero no es perfecto. Es importante que
                  sepas sus limitaciones.
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed pl-7">
                    A veces da información incorrecta o desactualizada. Si algo
                    es muy importante (salud, dinero, trámites legales),
                    verifica con fuentes oficiales o profesionales.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed pl-7">
                    ChatGPT no es un médico, abogado o contador. Puede darte
                    información general, pero no diagnósticos ni asesoramiento
                    profesional.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed pl-7">
                    No puede buscar noticias de hoy ni información actualizada
                    al minuto. Su conocimiento tiene una fecha límite.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed pl-7">
                    No puede enviar correos, hacer llamadas, comprar cosas o
                    realizar trámites en tu nombre.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-foreground">
            Uso responsable y acompañado de otras fuentes
          </h2>
          <Card>
            <CardContent className="pt-6 space-y-4">
              <p className="text-lg leading-relaxed">
                Para usar ChatGPT de forma segura y responsable, sigue estas
                recomendaciones:
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-accent p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Si ChatGPT te da información sobre salud, finanzas o
                    trámites, confírmala con fuentes oficiales o profesionales.
                  </p>
                </div>
                ...
                <div className="bg-accent p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Si algo suena demasiado bueno para ser verdad o te parece
                    extraño, probablemente necesites verificarlo.
                  </p>
                </div>
                ...
                <div className="bg-accent p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Si tienes dudas sobre si algo es seguro, pregunta a un
                    familiar, amigo o usa nuestro canal de soporte.
                  </p>
                </div>
                ...
                <div className="bg-accent p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Usa una contraseña fuerte para tu cuenta de ChatGPT y no la
                    compartas con nadie.
                  </p>
                </div>
                ...
                <div className="bg-accent p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Si usas ChatGPT en una computadora que comparten varias
                    personas, recuerda cerrar sesión cuando termines.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <AlertDescription className="space-y-3">
                ...
                {score === 5 && (
                  <p className="text-base leading-relaxed">
                    ¡Excelente! Has comprendido perfectamente las buenas
                    prácticas de seguridad. Estás listo para usar ChatGPT de
                    forma segura.
                  </p>
                )}
                {score === 4 && (
                  <p className="text-base leading-relaxed">
                    ¡Muy bien! Has comprendido la mayoría del contenido sobre
                    seguridad. Puedes comenzar a usar ChatGPT con confianza.
                  </p>
                )}
                {score === 3 && (
                  <p className="text-base leading-relaxed">
                    Bien hecho. Te recomendamos revisar el contenido del módulo
                    para reforzar los conceptos de seguridad.
                  </p>
                )}
                {score < 3 && (
                  <p className="text-base leading-relaxed">
                    Te sugerimos revisar el contenido del módulo con atención,
                    especialmente las secciones sobre seguridad y privacidad.
                  </p>
                )}
                <Button
